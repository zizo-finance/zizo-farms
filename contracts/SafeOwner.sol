...
interface MasterChef {
    ...
    function updateEmissionRate(uint256 _pantyPerBlock) external;
...
contract SafeOwner is Ownable {
    ...
    function updateEmissionRate(uint256 _pantyPerBlock) public onlyOwner {
        masterChef.updateEmissionRate(_pantyPerBlock);
    }
